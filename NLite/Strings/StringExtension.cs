...
namespace NLite
{
  ...
  //      public StringBuffer(StringBuilder text)
  //      {
  //          Buffer = text;
  //      }
  //      /// <summary>
  ...
  //      {
  //          return AppendLine(Indentation.Same);
  //      }
  //      /// <summary>
  //      /// 
  //      /// </summary>
  ...
  //      /// <returns></returns>
  //      public StringBuffer AppendLine(Indentation style)
  //      {
  //          this.Buffer.AppendLine();
  //          this.Indent(style);
  //          for (int i = 0, n = this.depth; i < n; i++)
  //          {
  //              Buffer.Append("\t");
  //          }
  ...
  //      /// <param name="args"></param>
  //      /// <returns></returns>
  //      public StringBuffer AppendFormat(string fmt, params object[] args)
  //      {
  ...
  //      /// <param name="style"></param>
  //      /// <returns></returns>
  //      public StringBuffer Indent(Indentation style)
  //      {
  ...
  //      /// <returns></returns>
  //      public StringBuffer Append(Action handler)
  //      {
  //          if (handler != null)
  //              handler();
  //          return this;
