...
namespace NLite.Collections
{
    ...
    {
        static readonly Type SerializedValueType = typeof(SerializedValue);
       ...
       /// <returns></returns>
        ...
        void OnPropertyChanged(string propertyName, object newValue, object oldValue)
        {
            ...
            else
            {
                ...
                if (PropertyChanged != null)
                    PropertyChanged(this, new NLite.ComponentModel.PropertyChangedEventArgs(propertyName, oldValue, newValue));
            }
        }
        /// <summary>
        /// 
