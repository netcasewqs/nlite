...
namespace NLite.Reflection
{
    ...
    namespace Internal
    {
        ...
        class GacCache
        {
            ...
            /// This scheme must only be used by Windows Installer itself.
            /// </summary>
            static Guid FUSION_REFCOUNT_UNINSTALL_SUBKEY_GUID
            {
                get
                {
            ...
            /// 
            /// </summary>
            static Guid FUSION_REFCOUNT_FILEPATH_GUID
            {
                get
                {
            ...
            /// 
            /// </summary>
            static Guid FUSION_REFCOUNT_OPAQUE_STRING_GUID
            {
                get
                {
            ...
            /// 
            /// </summary>
            static Guid FUSION_REFCOUNT_MSI_GUID
            {
                get
                {
            ...
            static String GetGACPath()
            {
                uint bufferSize = 255;
                StringBuilder buffer = new StringBuilder((int)bufferSize);
                GacCache.GetCachePath(ASM_CACHE_FLAGS.ASM_CACHE_GAC, buffer, ref bufferSize);
                return buffer.ToString();
            }

            static String GetZapPath()
            {
                uint bufferSize = 255;
                StringBuilder buffer = new StringBuilder((int)bufferSize);
                GacCache.GetCachePath(ASM_CACHE_FLAGS.ASM_CACHE_ZAP, buffer, ref bufferSize);
                return buffer.ToString();
            }
