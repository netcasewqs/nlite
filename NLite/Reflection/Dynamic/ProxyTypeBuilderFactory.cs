...
namespace NLite.Reflection.Dynamic
{
    ...
    /// </summary>
    sealed class ProxyTypeBuilderFactory : ITypeBuilderFactory, ITypeRepository
    {
        /// <summary>
        /// The dynamic assembly name.
        /// </summary>
        private const string DynamicAssemblyName = "NLite.Reflection.Dynamic";
        ...
        /// </summary>
        private const string DynamicAssemblyKeyPairResourceName = "NLite.Reflection.Dynamic.Internal.Dynamic.snk";
        ...
        internal void SaveAssembly()
        {
            ...
            _assemblyBuilder.Save(DynamicModuleName);
        }
