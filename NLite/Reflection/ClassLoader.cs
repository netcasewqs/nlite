...
namespace NLite.Reflection
{
    ...
    public class AppBaseAssemblyResolver : FileDirectoryAssemblyResolver
    {
        ...
        /// 
        /// </summary>
        public AppBaseAssemblyResolver() : base(NLiteEnvironment.ApplicationPhysicalPath, true) { }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="includeChildDirectory"></param>
        public AppBaseAssemblyResolver(bool includeChildDirectory) : base(NLiteEnvironment.ApplicationPhysicalPath, includeChildDirectory) { }
    }
