...
namespace NLite
{
    ...
    public sealed class Converter
    {
        ...
        {
#if DEBUG  && SDK4
            //var assemblyName = new AssemblyName("NLite.Data.Dynamic.Converter");
            ...
            //var Module = assemblyBuilder.GetModules().FirstOrDefault();
...
#if DEBUG  && SDK4
            //HashSet<string> methodFlags = new HashSet<string>();
#endif
...
#if DEBUG && SDK4
                //var toType = tuple.ToType.IsNullable() ? Nullable.GetUnderlyingType(tuple.ToType) : tuple.ToType;
                //var fromTypeName = tuple.FromType.TypeHandle.Value; 
                //var methodName = "To" + toType.Name;
                //if (methodFlags.Contains(methodName + fromTypeName))
                //    methodName = "ToNullable"+toType.Name;
                //if (methodFlags.Contains(methodName + fromTypeName))
                //    methodName = "To" + toType.Name+"_"+ Guid.NewGuid().ToString().Replace("-","");
              
                //var method = typeBuilder.DefineMethod(methodName, MethodAttributes.FamANDAssem | MethodAttributes.Family | MethodAttributes.Static);
                //lambda.CompileToMethod(method);
                //methodFlags.Add(methodName + fromTypeName);
#endif
...
#if DEBUG  && SDK4
            //var entityMapperType = typeBuilder.CreateType();
        ...
        {
#if SDK35
            return DefaultExpressionExpressions.GetDefaultExpression(type);
#else
